...
if c==1:
    ...
    net = cv2.dnn.readNetFromCaffe('C:/Users/Ananya Pal/VS Code/Visual Studio Code/AnanyaPal_Python/MODEL/colorization_deploy_v2.prototxt','C:/Users/Ananya Pal/VS Code/Visual Studio Code/AnanyaPal_Python/MODEL/colorization_release_v2.caffemodel')
    pts = np.load('C:/Users/Ananya Pal/VS Code/Visual Studio Code/AnanyaPal_Python/MODEL/pts_in_hull.npy')
    ...
    if c1==1 :
        cv2.imwrite("1.Colour pic.png", colorized)
        print("Picture Saved!!")
    else:
...
#2. Animated Image
    ...
    if c1==1 :
        cv2.imwrite("2.Animation.png", cartoon)
        print("Picture Saved!!")
    else:
        print("Okay!! Picture Not Saved.")
...
#3. Pen(cil) sketches the image
    ...
    if c1==1 :
        cv2.imwrite("3.Sketch.png", penSktch_img)
        print("Picture Saved!!")
    else:
        print("Okay!! Picture Not Saved.")
...
#5. Colour to Negative Image
    ...
    if c1==1 :
        cv2.imwrite("5.-ve.png", inv_grey_img)
        print("Picture Saved!!")
    else:
        print("Okay!! Picture Not Saved.")
...
#6. Colour to Binary Image
    ...
    c1=int(input("Do you want to save the Negative Picture? Press 1 for Yes and 2 for No: "))
    if c1==1 :
        cv2.imwrite("6.Binary image.png", bin_img)
        print("Picture Saved!!")
    else:
        print("Okay!! Picture Not Saved.")
